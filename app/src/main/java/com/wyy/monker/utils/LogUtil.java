...
import static com.wyy.monker.utils.ImageUtil.createOrExistsFile;
...
public class LogUtil {
    ...
    public static void init(boolean logSwitch, boolean log2FileSwitch, char logFilter, String tag) {
        if (Environment.MEDIA_MOUNTED.equals(Environment.getExternalStorageState())) {
            dir = BaseApplication.getIntance().getContext().getExternalCacheDir().getPath() + File.separator;
        } else {
            dir = BaseApplication.getIntance().getContext().getCacheDir().getPath() + File.separator;
        }
    ...
    public static Builder getBuilder() {
        if (Environment.MEDIA_MOUNTED.equals(Environment.getExternalStorageState())) {
            dir = BaseApplication.getIntance().getContext().getExternalCacheDir().getPath() + File.separator + "log" + File.separator;
        } else {
            dir = BaseApplication.getIntance().getContext().getCacheDir().getPath() + File.separator + "log" + File.separator;
        }
        return new Builder();
    }
