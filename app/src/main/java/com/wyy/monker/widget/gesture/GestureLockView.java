...
public class GestureLockView extends View {
     ...
     */
    private float mInnerCircleRadiusRate = 0.8F;
    ...
    protected void onDraw(Canvas canvas) {
        ...
        switch (mCurrentStatus) {
            case STATUS_FINGER_ON:
                ...
                canvas.drawCircle(mCenterX, mCenterY, SizeUtil.dp2px(8), mPaint);
                break;
            case STATUS_FINGER_UP:
                ...
                // 绘制内圆
                mPaint.setStyle(Paint.Style.FILL);
                canvas.drawCircle(mCenterX, mCenterY, SizeUtil.dp2px(8)      //*mInnerCircleRadiusRate
                        , mPaint);
