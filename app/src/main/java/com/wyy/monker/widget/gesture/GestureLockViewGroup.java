package com.wyy.monker.widget.gesture;
...
//    private int[] mAnswer = {0, 1, 2, 5, 8};
     ...
     */
    private int mNoFingerInnerCircleColor = Color.parseColor("#F6F6F6");
    /**
     * GestureLockView无手指触摸的状态下外圆的颜色
     */
    private int mNoFingerOuterCircleColor = Color.parseColor("#C1B087");
    /**
     * GestureLockView手指触摸的状态下内圆和外圆的颜色
     */
    private int mFingerOnColor = Color.parseColor("#C1B087");
    /**
    ...
    public GestureLockViewGroup(Context context, AttributeSet attrs,
        ...
        mPaint.setColor(Color.parseColor("#FFD2A7"));
        mPath = new Path();
    }
...
//            mPaint.setStrokeWidth(mGestureLockViewWidth * 0.1f);
        ...
        switch (action) {
                ...
                if (child != null) {
                    ...
                    if (!mChoose.contains(cId)) {
                        ...
                        if (mOnGestureLockViewListener != null)
                            mOnGestureLockViewListener.onBlockSelected(cId, mcurChooseStr);
                        // 设置指引线的起点
            ...
            case MotionEvent.ACTION_UP:
                ...
                if (mOnGestureLockViewListener != null && mChoose.size() > 0) {
                    mOnGestureLockViewListener.onGestureEvent(checkAnswer(), mcurChooseStr);
                    if (this.mTryTimes == 0) {
    ...
    private boolean checkAnswer() {
        ...
        return TextUtils.equals(mcurChooseStr, mAnswer);
    }
    ...
    public interface OnGestureLockViewListener {
         ...
         * 单独选中元素的Id
         */
        public void onBlockSelected(int cId, String pwd);
         ...
         * @param matched
         */
        public void onGestureEvent(boolean matched, String pwd);
